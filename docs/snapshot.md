...
# Market Snapshot — 2026-07-28

Auto-generated daily by the burrito pipeline. See [[data-pipeline]] for how.

## Bitcoin

- **Price**: $63,710.94 · **Risk**: 0.032 ([[risk-metric|methodology]])
- **Fair value** (fan median): $113,404.69
- **MVRV**: 1.2055 · **NUPL**: 0.1705 · **Puell**: 0.648
- **Fear & Greed**: 29

## Market

- **Total market cap** (tracked): $1941.921B · **BTC dominance**: 65.84% · **SSR**: 4.94

## Top assets by market cap

| Asset | Price | 24h | Risk |
|---|---|---|---|
| BTC | $63,711 | -2.49% | 0.01 |
| ETH | $1,758 | +3.39% | 0.02 |
